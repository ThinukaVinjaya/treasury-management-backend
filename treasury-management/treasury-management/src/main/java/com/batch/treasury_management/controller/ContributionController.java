...
public class ContributionController {
    ...
    @PreAuthorize("hasAnyRole('USER', 'TREASURER', 'SUPER_ADMIN')")   // ← Changed for Temp Treasurer
    public ResponseEntity<ApiResponse<ContributionResponse>> recordContribution(
        ...
        ContributionResponse response = contributionService.recordContribution(request, performedBy);
    ...
    @PreAuthorize("hasAnyRole('USER', 'TREASURER', 'SUPER_ADMIN')")   // ← Changed
    ...
    public ResponseEntity<ApiResponse<String>> softDeleteContribution(
        ...
        return ResponseEntity.ok(
                ApiResponse.success("Contribution soft deleted successfully."));
    }
